...
from noxipher.tx.scale import (
    serialize_u32, serialize_u64, serialize_u128, 
    serialize_string, serialize_transaction,
    SubstrateScaleEncoder
)

def test_scale_bigint_u128():
...
def test_substrate_compact_u32():
...
def test_unshielded_transaction_structure():
