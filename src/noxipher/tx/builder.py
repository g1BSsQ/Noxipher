...
class TransactionBuilder:
    ...
    async def _build_unshielded_transfer(
        ...
        try:
            ...
            raise TransactionError(f"Invalid recipient address: {e}")
    ...
    def _serialize_transaction(
        self, tx_data: dict, wallet: "MidnightWallet"
    ) -> bytes:
            ...
            try:
                ...
                if txs and txs[0].transaction_result:
                    ...
                    return TransactionReceipt(
                        ...
                        fee_paid=(
                            int(tx.fees.get("paid_fees", 0)) if tx.fees else 0
                        ),
                    )
            except Exception:
                pass
